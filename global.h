...
#define CURRENT_APP_VERSION         "1.0.3" //线上版本
#define CURRENT_VERSION_PRODUCTCODE "{5E87264F-FCFF-4987-9B21-B7E2C678F7C3}"        //当前版本的ProductCode每次软件升级需修改

#define HTTP_SERVER_DOMAIN_ADDRESS  "http://120.26.132.153:8080"  //"http://192.168.1.6:8080" //  //测试服务器  "http://112.124.61.54:8080"
...
typedef struct VERSION_INFO
{
    ...
    QString strUpdateContents;  //更新内容
    QString strV4;
    QString strV5;
    VERSION_INFO()
    {
...
public:
    ...
    static bool     bIsSyncOperation; //    是否开启同步操作
