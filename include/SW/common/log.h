...
/*
 * Simplified macro to send a verbose log message using the current SW_LOG_TAG.
 */
#ifndef ALOGV
#define ALOGV(...) ALOG(LOG_VERBOSE, SW_LOG_TAG, __VA_ARGS__)
#endif
...
/*
 * Simplified macro to send a debug log message using the current SW_LOG_TAG.
 */
#ifndef ALOGD
#define ALOGD(...) ALOG(LOG_DEBUG, SW_LOG_TAG, __VA_ARGS__)
#endif
...
/*
 * Simplified macro to send an info log message using the current SW_LOG_TAG.
 */
#ifndef ALOGI
#define ALOGI(...) ALOG(LOG_INFO, SW_LOG_TAG, __VA_ARGS__)
#endif
...
/*
 * Simplified macro to send a warning log message using the current SW_LOG_TAG.
 */
#ifndef ALOGW
#define ALOGW(...) ALOG(LOG_WARN, SW_LOG_TAG, __VA_ARGS__)
#endif
...
/*
 * Simplified macro to send an error log message using the current SW_LOG_TAG.
 */
#ifndef ALOGE
#define ALOGE(...) ALOG(LOG_ERROR, SW_LOG_TAG, __VA_ARGS__)
#endif
 ...
 */
#ifndef ALOGF
#define ALOGF(...) ALOG(LOG_FATAL, SW_LOG_TAG, __VA_ARGS__)
#endif
 ...
 *
 * Example:
 *  ALOG(LOG_WARN, NULL, "Failed with error %d", err);
 *
...
#define LOG_PRI(priority, tag, ...) \
    __sw_printLog(priority, tag, __VA_ARGS__)
#endif
 ...
 */
#ifndef __sw_printLog
#define __sw_printLog(prio, tag, ...) __sw_log_write(prio, tag, ##__VA_ARGS__)
#endif
...
void sw_log_init(int prio, const char* filename);
void sw_log_deinit(void);
...
#define ALOG_ASSERT(cond) \
    ...
    ? ((void)__sw_log_assert(__FILE__, __func__, __LINE__, #cond)) \
    : (void)0 )
#endif
